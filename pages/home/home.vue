					...
					<swiper class="swiper" :indicator-dots="false" autoplay="true" interval="5000" duration="1000" @change="swiperChange">
						<block v-for="(item, index) in imgUrls" :key="index">
							<swiper-item class="radius">
								<image v-if="item.url" :src="item.url" class="slide-image" mode="aspectFill" @click="swiperTarget(item.link)" />
								<button v-else class="slide-image" hover-class="btnHoverClass" open-type="share"></button>
							</swiper-item>
						</block>
					</swiper>
					<view class="dots">
