			...
			<view class="bannerTop">
				<view @click="toHouseList">
					<view class="bannerItem">
						<image class="bannerImg" src="../../static/homeIcon1.png" mode=""></image>
					</view>
					<span class="bannerText">房源管理</span>
				</view>
				<view @click="goRenterMange">
					<view class="bannerItem">
						<image class="bannerImg" src="../../static/homeIcon2.png" mode=""></image>
				...
				<view @click="goBillManage">
					<view class="bannerItem">
						<image class="bannerImg" src="../../static/homeIcon3.png" mode=""></image>
					</view>
					<span class="bannerText">账单管理</span>
				</view>
				<view>
					<view class="bannerItem">
						<image class="bannerImg" src="../../static/homeIcon4.png" mode=""></image>
					</view>
					<span class="bannerText">提醒</span>
				</view>
			</view>
		</view>
	</view>
